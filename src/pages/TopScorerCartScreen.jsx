...
import TopScorerCartItemComponent from '../components/TopScorerCartItemComponent';
import TopScorerComponent from '../components/TopScorerComponent';
        ...
        <>
          <View style={{height: height * 0.7}}>
            <ScrollView style={styles.flex} contentContainerStyle={styles.main}>
              {cart.map((item, index) => (
                <TopScorerCartItemComponent item={item} key={index} />
              ))}
            </ScrollView>
          </View>
        </>

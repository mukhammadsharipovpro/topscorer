...
import {burgerApp5} from '../assets/products';

const TopScorerCartItemComponent = ({item}) => {
  ...
  const productImage = burgerApp5.find(p => p.name === item.name)?.image;
...
export default TopScorerCartItemComponent;
